...
public class PosInvoice extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public DeliveryAddress DeliveryAddress;
   ...
   */
  public PosInvoice(java.lang.CharSequence InvoiceNumber, java.lang.Long CreatedTime, java.lang.Double CustomerCardNo, java.lang.Double TotalAmount, java.lang.Integer NumberOfItems, java.lang.CharSequence PaymentMethod, java.lang.Double TaxableAmount, java.lang.Double CGST, java.lang.Double SGST, java.lang.Double CESS, java.lang.CharSequence StoreID, java.lang.CharSequence PosID, java.lang.CharSequence CashierID, java.lang.CharSequence CustomerType, java.lang.CharSequence DeliveryType, DeliveryAddress DeliveryAddress, java.util.List<LineItem> InvoiceLineItems) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 15: DeliveryAddress = (DeliveryAddress)value$; break;
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PosInvoice>
    ...
    private DeliveryAddress.Builder DeliveryAddressBuilder;
    ...
    private Builder(PosInvoice.Builder other) {
      ...
      if (other.hasDeliveryAddressBuilder()) {
        this.DeliveryAddressBuilder = DeliveryAddress.newBuilder(other.getDeliveryAddressBuilder());
      }
    ...
    /**
      ...
      * @return This builder.
      */
    public PosInvoice.Builder setDeliveryAddress(DeliveryAddress value) {
     ...
     * @return This builder.
     */
    public DeliveryAddress.Builder getDeliveryAddressBuilder() {
      if (DeliveryAddressBuilder == null) {
        if (hasDeliveryAddress()) {
          setDeliveryAddressBuilder(DeliveryAddress.newBuilder(DeliveryAddress));
        } else {
          setDeliveryAddressBuilder(DeliveryAddress.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public PosInvoice.Builder setDeliveryAddressBuilder(DeliveryAddress.Builder value) {
    ...
    public PosInvoice build() {
      try {
        ...
        if (DeliveryAddressBuilder != null) {
          ...
          record.DeliveryAddress = fieldSetFlags()[15] ? this.DeliveryAddress : (DeliveryAddress) defaultValue(fields()[15]);
        }
